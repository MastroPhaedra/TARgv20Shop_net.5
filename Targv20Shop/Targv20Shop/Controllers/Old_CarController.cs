...
{
    public class Old_CarController : Controller
    {
        private readonly Targv20ShopDbContext _context;
        private readonly IOld_CarService _carService;

        public Old_CarController
            (
                Targv20ShopDbContext context,
                IOld_CarService carService
            )
        {
            _context = context;
        ...
        public IActionResult Old_Car()
        {
            var result = _context.Old_Car
